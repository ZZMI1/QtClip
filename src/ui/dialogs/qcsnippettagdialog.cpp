...
QCSnippetTagDialog::QCSnippetTagDialog(QWidget *pParent)
    ...
    , m_pRenameTagButton(new QPushButton(QCUiText(QString::fromUtf8("重命名所选"), QString::fromUtf8("Rename Selected")), this))
    , m_pDeleteTagButton(new QPushButton(QCUiText(QString::fromUtf8("删除所选"), QString::fromUtf8("Delete Selected")), this))
    , m_pSaveButton(nullptr)
    , m_pCancelButton(nullptr)
    , m_hashRenamedTags()
    , m_vecDeletedTagIds()
{
    setWindowTitle(QCUiText(QString::fromUtf8("管理标签"), QString::fromUtf8("Manage Tags")));
    resize(460, 560);

    m_pContextLabel->setWordWrap(true);
    m_pTagListWidget->setAlternatingRowColors(true);
    m_pSelectedTagNameLineEdit->setPlaceholderText(QCUiText(QString::fromUtf8("选择一个现有标签进行操作"), QString::fromUtf8("Select one existing tag to rename")));
    m_pNewTagLineEdit->setPlaceholderText(QCUiText(QString::fromUtf8("保存时创建一个新标签"), QString::fromUtf8("Create a new tag on save")));
    m_pSelectedTagUsageLabel->setText(QCUiText(QString::fromUtf8("被 0 个 snippet 使用。"), QString::fromUtf8("Used by 0 snippets.")));
    ...
    m_pSaveButton->setText(QCUiText(QString::fromUtf8("保存"), QString::fromUtf8("Save")));
    m_pSaveButton->setDefault(true);

    QVBoxLayout *pLayout = new QVBoxLayout();
    pLayout->addWidget(m_pContextLabel);
    pLayout->addWidget(new QLabel(QCUiText(QString::fromUtf8("标签"), QString::fromUtf8("Tags")), this));
    pLayout->addWidget(m_pTagListWidget);
    pLayout->addWidget(new QLabel(QCUiText(QString::fromUtf8("重命名所选标签"), QString::fromUtf8("Rename Selected Tag")), this));
    ...
    pLayout->addWidget(new QLabel(QCUiText(QString::fromUtf8("新标签"), QString::fromUtf8("New Tag")), this));
    ...
    setContextText(QCUiText(QString::fromUtf8("勾选的标签将保持绑定。您也可以在此处创建、重命名或删除标签。"), QString::fromUtf8("Checked tags stay bound. You can also create, rename, or delete tags here.")));
...
{
    return QString::fromUtf8("%1 (%2)").arg(strTagName.trimmed().isEmpty() ? QCUiText(QString::fromUtf8("无标题标签"), QString::fromUtf8("Untitled Tag")) : strTagName.trimmed()).arg(nUsageCount);
}
...
void QCSnippetTagDialog::updateSelectionState()
{
    ...
    if (bHasCurrentItem)
    {
        ...
        m_pSelectedTagUsageLabel->setText(QCUiText(QString::fromUtf8("被 %1 个 snippet 使用。"), QString::fromUtf8("Used by %1 snippet(s).")).arg(usageCountForItem(pCurrentItem)));
    }
    else
    {
...
void QCSnippetTagDialog::renameSelectedTag()
{
    ...
    {
        QMessageBox::warning(this, QCUiText(QString::fromUtf8("管理标签"), QString::fromUtf8("Manage Tags")), QCUiText(QString::fromUtf8("标签名称不能为空。"), QString::fromUtf8("Tag name cannot be empty.")));
        return;
    }
    ...
    for (int i = 0; i < m_pTagListWidget->count(); ++i)
    {
        ...
        {
            QMessageBox::warning(this, QCUiText(QString::fromUtf8("管理标签"), QString::fromUtf8("Manage Tags")), QCUiText(QString::fromUtf8("已存在同名标签。"), QString::fromUtf8("A tag with the same name already exists.")));
            return;
        }
    }
...
void QCSnippetTagDialog::deleteSelectedTag()
{
    ...
    const QString strMessage = nUsageCount > 0
        ? QCUiText(QString::fromUtf8("是否删除标签“%1”？\n它当前被 %2 个 snippet 使用，删除后将从这些 snippet 中移除。"), QString::fromUtf8("Delete tag '%1'?\nIt is currently used by %2 snippet(s) and will be removed from them.")).arg(strTagName, QString::number(nUsageCount))
        : QCUiText(QString::fromUtf8("是否删除标签“%1”？"), QString::fromUtf8("Delete tag '%1'?")).arg(strTagName);
    if (QMessageBox::Yes != QMessageBox::question(this,
                                                  QCUiText(QString::fromUtf8("管理标签"), QString::fromUtf8("Manage Tags")),
                                                  strMessage,
